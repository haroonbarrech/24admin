...
const PasswordChange= props => {
    ...
    return(
        ...
        <Text style={{paddingLeft:10,marginBottom:10,fontWeight:'bold'}}>New Password</Text>
...
flexDirection: 'row', justifyContent: 'space-between' }}>
  ...
  style={{width: '80%'}}
   ...
   />
    ...
    <MaterialCommunityIcons name={rightIcon} size={30} color="lightgrey" style={{paddingRight:10,width: '100%'}}  />
    </Pressable>
      ...
      <View style={{height:responsiveHeight(5)}}>
            ...
            <Text style={{paddingLeft:10,marginBottom:10,fontWeight:'bold'}}>Confim PasswordChange</Text>
            {/* ----------------------Password-----------------------*/}
            <View style={{ position: 'relative', display: 'flex', flexDirection: 'row',
        paddingLeft:20,borderWidth:1,marginLeft:13,borderColor:'grey',borderRadius:18,width:responsiveWidth(90),height:responsiveHeight(6),
         justifyContent: 'center', alignItems: 'center'}}>
...
flexDirection: 'row', justifyContent: 'space-between' }}>
  ...
  <TouchableOpacity>
        <Text style={{paddingLeft:10,marginTop:50,fontWeight:'bold',color:'#ff5770'}}>Resend OTP?</Text>
        </TouchableOpacity>
        </View>
         {/* ----------------------View for height-----------------------*/}
         <View style={{height:responsiveHeight(10)}}>
